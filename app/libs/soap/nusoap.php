	...
	*/
	function connect($connection_timeout=0,$response_timeout=30){
	  	...
	  	//       loaded), and until PHP5 stream_get_wrappers is not available.
                //20110308 AG: Habilité este codigo que estaba comentariado, ignoré lo que habia aqui de la version de php y lo cambie por un chequeo de si la extension de curl esta habilitada o no...
